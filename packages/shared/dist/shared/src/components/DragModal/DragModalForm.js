...
var AntdModalDrag = function (props) {
    ...
    return (React.createElement(ModalForm, __assign({}, props, { title: titleNode, modalProps: __assign({ destroyOnClose: true, modalRender: function (modal) { return (React.createElement(Draggable, { disabled: disabled }, modal)); } }, props.modalProps) }), children));
};
