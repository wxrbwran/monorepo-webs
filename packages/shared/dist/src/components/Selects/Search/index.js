...
var Search = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Input.Search, { placeholder: placeholder, value: wordKey, style: { width: width || 160, float: float || 'right' }, onSearch: handleSearchKey, onChange: handleChangeKey, ref: inputRef })));
};
