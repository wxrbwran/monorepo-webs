...
export var Role = {
    ...
    PATIENT: roleType('YWLG0L', 79, 70, 78, '患者(默认在心之力系统-慢病服务团队)'),
    ...
    ORG_IH: roleType('jW2m0r', 219, 210, 218, '互联网医院'),
    PATIENT_IH: roleType('Y4nb4D', 0, 0, 0, '互联网医院患者'),
    DOCTOR_IH: roleType('r4qE4y', 0, 0, 0, '互联网医院医生'),
    DOCTOR_IH_SENIOR: roleType('Y0ZD4o', 0, 0, 0, '互联网医院科室正高级医师'),
    DOCTOR_IH_DEPUTY: roleType('6e8JWY', 0, 0, 0, '互联网医院科室副高级医师'),
...
export function fetchRolePropById(id) {
    ...
    var activeRole = roleKey.filter(function (key) { return Role[key].id === id; })[0];
