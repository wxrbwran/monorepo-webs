...
export const OUT_HOSPITAL_PATIENT = 'https://d.xinzhili.cn/out-hospital-patient/index.html#/data-statistics';
...
export const REFRESH_LIST = 120 * 1000;
export const ISSUE_LIST = 10;
export const TABLE_PAGESIZE = 10;
export const LATES_HEALTH_SIZE = 10;
