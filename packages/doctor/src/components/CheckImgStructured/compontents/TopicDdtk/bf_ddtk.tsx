                ...
                return (
                  ...
                  >
                    <div className="flex justify-end items-center mb-15">
                      <div className={styles.add_btn} onClick={() => handleAddSymbol()}>+ 添加问题</div>
                      <img className="ml-10" src={delIcon} onClick={(e: any) => handleDelQuestion(e, quesIndex)} />
                    </div>
                    <div>
                      <span>示例:</span>
                      {
                        example.map((exItem, exInx) => (
                          <div key={exItem.q}>
                            <span className={styles.order_number}>{exInx + 1}</span>
                            <span className="ml-5">{exItem.q}:</span>
