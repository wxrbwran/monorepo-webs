...
function ArticleCreate() {
  ...
  const uploadOss = () => {
    ...
    const videoCover =
      'poster=https://xzl-user-avatar.oss-cn-hangzhou.aliyuncs.com/dev/0/f8460268-aebc-4b92-a78a-375dae0a94db视频@2x.png';
    const formatHtmlTxt = rickText
  ...
  return (
    <div className="py-30 px-60">
      ...
      <div className="main">
        ...
        <RichText handleChange={handleChange} value={richText?.content?.text?.ops} />
      </div>
    </div>
  );
}
