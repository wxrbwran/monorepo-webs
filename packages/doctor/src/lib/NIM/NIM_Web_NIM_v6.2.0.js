!function (e, t) {
  ...
  return function (e) {
    ...
    }, l.getFileInfo = (f = { ppt: 1, pptx: 2, pdf: 3 }, function (e) {
      var t = {};
      if (!(e = l.verifyFileInput(e)).files) return t;
      var n = e.files[0];
      return g && (t.name = n.name, t.size = n.size, t.type = n.name.match(/\.(\w+)$/), t.type = t.type && t.type[1].toLowerCase(), t.transcodeType = f[t.type] || 0), t;
    }), l.sizeText = (p = ['B', 'KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'BB'], function (e) {
      var t,
        n = 0;
      do {
        t = (e = Math.floor(100 * e) / 100) + p[n], e /= 1024, n++;
      } while (e > 1);
      return t;
    ...
    r.weixinNetcall = r.nrtcNetcall = {
      ...
      return (a = r.genNosProtocolUrl(a)).replace('{bucket}', n)
        .replace('{object}', t);
    }, r.genFileUrl = function (e) {
      var t = e.bucket,
        n = e.objectName;
      return r.genNosProtocolUrl(r.replaceUrl)
        .replace('{bucket}', t)
        .replace('{object}', n);
    }, r.genNosProtocolUrl = function (e) {
      return /^http/.test(e) ? r.httpsEnabled && (e = e.replace('http', 'https')) : e = r.httpsEnabled ? 'https://' + e : 'http://' + e, e;
    }, e.exports = r;
  }, , , , function (e, t, n) {
    var r = n(42)('wks'),
      s = n(29),
    ...
    (function (e) {
      ...
      t.getGlobal = o, t.detectCSSFeature = function (e) {
        ...
        return t;
      }, t.fix = a, t.getYearStr = c, t.getMonthStr = u, t.getDayStr = l, t.getHourStr = m, t.getMinuteStr = d, t.getSecondStr = f, t.getMillisecondStr = p, t.dateFromDateTimeLocal = function (e) {
        return e = '' + e, new Date(e.replace(/-/g, '/')
          .replace('T', ' '));
      ...
      }, t.forOwn = U, t.mixin = j, t.isJSON = N, t.parseJSON = function e(t) {
        try {
          N(t) && (t = JSON.parse(t)), x(t) && U(t, function (n, r) {
            switch (v(r)) {
              case'string':
              case'object':
                t[n] = e(r);
    ...
    var r = n(8),
      ...
      c = function (e, t, n) {
        ...
        for (u in f && (n = t), n) {
          (l = !d && M && void 0 !== M[u]) && a(v, u) || (m = l ? M[u] : n[u], v[u] = f && 'function' != typeof M[u] ? n[u] : h && l ? i(m, r) : y && M[u] == m ? function (e) {
      ...
      var o = function () {
        ...
        return function t(n) {
          ...
          var h,
            ...
            C = /\bJava/.test(P) && s.java,
            O = C && m(s.environment) == k,
            w = C ? 'a' : 'α',
            x = C ? 'b' : 'β',
            A = s.document || {},
            ...
            j = null,
            F = n == g,
            N = F && _ && 'function' == typeof _.version && _.version(),
            D = f([{
              label: 'EdgeHTML',
              pattern: 'Edge',
            }, 'Trident', {
              ...
              return e || RegExp('\\b' + (t.pattern || d(t)) + '\\b', 'i')
                .exec(n) && (t.label || t);
            }),
            L = function (e) {
            ...
            q = function (e) {
              return f(e, function (e, t, r) {
                return e || (t[B] || t[/^[a-z]+(?: +[a-z]+\b)*/i.exec(B)] || RegExp('\\b' + d(r) + '(?:\\b|\\w*\\d)', 'i')
                  .exec(n)) && r;
              });
            }({
            ...
            H = function (e) {
              return f(e, function (e, t) {
                ...
                return !e && (e = RegExp('\\b' + r + '(?:/[\\d.]+|[ \\w.]*)', 'i')
                  ...
                  return t && n && /^Win/i.test(e) && !/^Windows Phone /i.test(e) && (r = r[/[\d.]+$/.exec(e)]) && (e = 'Windows ' + r), e = String(e), t && n && (e = e.replace(RegExp(t, 'i'), n)), e = u(e.replace(/ ce$/i, ' CE')
                    .replace(/\bhpw/i, 'web')
          ...
          if (D && (D = [D]), q && !B && (B = W([q])), (h = /\bGoogle TV\b/.exec(B)) && (B = h[0]), /\bSimulator\b/i.test(n) && (B = (B ? B + ' ' : '') + 'Simulator'), 'Opera Mini' == L && /\bOPiOS\b/.test(n) && U.push('running in Turbo/Uncompressed mode'), 'IE' == L && /\blike iPhone OS\b/.test(n) ? (q = (h = t(n.replace(/like iPhone OS/, ''))).manufacturer, B = h.product) : /^iP/.test(B) ? (L || (L = 'Safari'), H = 'iOS' + ((h = / OS ([\d_]+)/i.exec(n)) ? ' ' + h[1].replace(/_/g, '.') : '')) : 'Konqueror' != L || /buntu/i.test(H) ? q && 'Google' != q && (/Chrome/.test(L) && !/\bMobile Safari\b/i.test(n) || /\bVita\b/.test(B)) || /\bAndroid\b/.test(H) && /^Chrome/.test(L) && /\bVersion\//i.test(n) ? (L = 'Android Browser', H = /\bAndroid\b/.test(H) ? H : 'Android') : 'Silk' == L ? (/\bMobi/i.test(n) || (H = 'Android', U.unshift('desktop mode')), /Accelerated *= *true/i.test(n) && U.unshift('accelerated')) : 'PaleMoon' == L && (h = /\bFirefox\/([\d.]+)\b/.exec(n)) ? U.push('identifying as Firefox ' + h[1]) : 'Firefox' == L && (h = /\b(Mobile|Tablet|TV)\b/i.exec(n)) ? (H || (H = 'Firefox OS'), B || (B = h[1])) : !L || (h = !/\bMinefield\b/i.test(n) && /\b(?:Firefox|Safari)\b/.exec(L)) ? (L && !B && /[\/,]|^[^(]+?\)/.test(n.slice(n.indexOf(h + '/') + 8)) && (L = null), (h = B || q || H) && (B || q || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(H)) && (L = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(H) ? H : h) + ' Browser')) : 'Electron' == L && (h = (/\bChrome\/([\d.]+)\b/.exec(n) || 0)[1]) && U.push('Chromium ' + h) : H = 'Kubuntu', N || (N = f(['(?:Cloud9|CriOS|CrMo|Edge|FxiOS|IEMobile|Iron|Opera ?Mini|OPiOS|OPR|Raven|SamsungBrowser|Silk(?!/[\\d.]+$))', 'Version', d(L), '(?:Firefox|Minefield|NetFront)'], function (e, t) {
            ...
            if (b = 'global', M = null != (v = s) ? (0, i.default)(v[b]) : 'number', /^(?:boolean|number|string|undefined)$/.test(M) || 'object' == M && !v[b]) {
              ...
              'object' === (0, i.default)(s.process) && !s.process.browser && (h = s.process) && ('object' === (0, i.default)(h.versions) && ('string' == typeof h.versions.electron ? (U.push('Node ' + h.versions.node), L = 'Electron', N = h.versions.electron) : 'string' == typeof h.versions.nw && (U.push('Chromium ' + N, 'Node ' + h.versions.node), L = 'NW.js', N = h.versions.nw)), L || (L = 'Node.js', R = h.arch, H = h.platform, N = (N = /[\d.]+/.exec(h.version)) ? N[0] : null));
            }
            H = H && u(H);
          }
          if (N && (h = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(N) || /(?:alpha|beta)(?: ?\d)?/i.exec(n + ';' + (F && c.appMinorVersion)) || /\bMinefield\b/i.test(n) && 'a') && (j = /b/i.test(h) ? 'beta' : 'alpha', N = N.replace(RegExp(h + '\\+?$'), '') + ('beta' == j ? x : w) + (/\d+\+?/.exec(h) || '')), 'Fennec' == L || 'Firefox' == L && /\b(?:Android|Firefox OS)\b/.test(H)) {
            L = 'Firefox Mobile';
          } else if ('Maxthon' == L && N) {
            N = N.replace(/\.[\d.]+/, '.x');
          } else if (/\bXbox\b/i.test(B)) {
            'Xbox 360' == B && (H = null), 'Xbox 360' == B && /\bIEMobile\b/.test(n) && U.unshift('mobile mode');
            ...
            if ('IE' == L && F) {
              ...
              (/\bBlackBerry\b/.test(B) || /\bBB10\b/.test(n)) && (h = (RegExp(B.replace(/ +/g, ' *') + '/([.\\d]+)', 'i')
                .exec(n) || 0)[1] || N) ? (H = ((h = [h, /BB10/.test(n)])[1] ? (B = null, q = 'BlackBerry') : 'Device Software') + ' ' + h[0], N = null) : this != l && 'Wii' != B && (F && _ || /Opera/.test(L) && /\b(?:MSIE|Firefox)\b/i.test(n) || 'Firefox' == L && /\bOS X (?:\d+\.){2,}/.test(H) || 'IE' == L && (H && !/^Win/.test(H) && N > 5.5 || /\bWindows XP\b/.test(H) && N > 8 || 8 == N && !/\bTrident\b/.test(n))) && !r.test(h = t.call(l, n.replace(r, '') + ';')) && h.name && (h = 'ing as ' + h.name + ((h = h.version) ? ' ' + h : ''), r.test(L) ? (/\bIE\b/.test(h) && 'Mac OS' == H && (H = null), h = 'identify' + h) : (h = 'mask' + h, L = E ? u(E.replace(/([a-z])([A-Z])/g, '$1 $2')) : 'Opera', /\bIE\b/.test(h) && (H = null), F || (N = null)), D = ['Presto'], U.push(h));
            }
          } else {
            L += ' Mobile';
          }
          (h = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(n) || 0)[1]) && (h = [parseFloat(h.replace(/\.(\d)$/, '.0$1')), h], 'Safari' == L && '+' == h[1].slice(-1) ? (L = 'WebKit Nightly', j = 'alpha', N = h[1].slice(0, -1)) : N != h[1] && N != (h[2] = (/\bSafari\/([\d.]+\+?)/i.exec(n) || 0)[1]) || (N = null), h[1] = (/\bChrome\/([\d.]+)/i.exec(n) || 0)[1], 537.36 == h[0] && 537.36 == h[2] && parseFloat(h[1]) >= 28 && 'WebKit' == D && (D = ['Blink']), F && (T || h[1]) ? (D && (D[1] = 'like Chrome'), h = h[1] || ((h = h[0]) < 530 ? 1 : h < 532 ? 2 : h < 532.05 ? 3 : h < 533 ? 4 : h < 534.03 ? 5 : h < 534.07 ? 6 : h < 534.1 ? 7 : h < 534.13 ? 8 : h < 534.16 ? 9 : h < 534.24 ? 10 : h < 534.3 ? 11 : h < 535.01 ? 12 : h < 535.02 ? '13+' : h < 535.07 ? 15 : h < 535.11 ? 16 : h < 535.19 ? 17 : h < 536.05 ? 18 : h < 536.1 ? 19 : h < 537.01 ? 20 : h < 537.11 ? '21+' : h < 537.13 ? 23 : h < 537.18 ? 24 : h < 537.24 ? 25 : h < 537.36 ? 26 : 'Blink' != D ? '27' : '28')) : (D && (D[1] = 'like Safari'), h = (h = h[0]) < 400 ? 1 : h < 500 ? 2 : h < 526 ? 3 : h < 533 ? 4 : h < 534 ? '4+' : h < 535 ? 5 : h < 537 ? 6 : h < 538 ? 7 : h < 601 ? 8 : '8'), D && (D[1] += ' ' + (h += 'number' == typeof h ? '.x' : /[.+]/.test(h) ? '' : '+')), 'Safari' == L && (!N || parseInt(N) > 45) && (N = h)), 'Opera' == L && (h = /\bzbov|zvav$/.exec(H)) ? (L += ' ', U.unshift('desktop mode'), 'zvav' == h ? (L += 'Mini', N = null) : L += 'Mobile', H = H.replace(RegExp(' *' + h + '$'), '')) : 'Safari' == L && /\bChrome\b/.exec(D && D[1]) && (U.unshift('desktop mode'), L = 'Chrome Mobile', N = null, /\bOS X\b/.test(H) ? (q = 'Apple', H = 'iOS 4.3+') : H = null), N && 0 == N.indexOf(h = /[\d.]+$/.exec(H)) && n.indexOf('/' + h + '-') > -1 && (H = p(H.replace(h, ''))), D && !/\b(?:Avant|Nook)\b/.test(L) && (/Browser|Lunascape|Maxthon/.test(L) || 'Safari' != L && /^iOS/.test(H) && /\bSafari\b/.test(D[1]) || /^(?:Adobe|Arora|Breach|Midori|Opera|Phantom|Rekonq|Rock|Samsung Internet|Sleipnir|Web)/.test(L) && D[1]) && (h = D[D.length - 1]) && U.push(h), U.length && (U = ['(' + U.join('; ') + ')']), q && B && B.indexOf(q) < 0 && U.push('on ' + q), B && U.push((/^on /.test(U[U.length - 1]) ? '' : 'on ') + B), H && (h = / ([\d.+]+)$/.exec(H), y = h && '/' == H.charAt(H.length - h[0].length - 1), H = {
            architecture: 32,
          ...
          }), (h = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(R)) && !/\bi686\b/i.test(R) ? (H && (H.architecture = 64, H.family = H.family.replace(RegExp(' *' + h), '')), L && (/\bWOW64\b/i.test(n) || F && /\w(?:86|32)$/.test(c.cpuClass || c.platform) && !/\bWin64; x64\b/i.test(n)) && U.unshift('32-bit')) : H && /^OS X/.test(H.family) && 'Chrome' == L && parseFloat(N) >= 39 && (H.architecture = 64), n || (n = null);
          var z = {};
          return z.description = n, z.layout = D && D[0], z.manufacturer = q, z.name = L, z.prerelease = j, z.product = B, z.ua = n, z.version = L && N, z.os = H || {
            architecture: null,
            family: null,
            version: null,
            toString: function () {
          ...
          }, z.parse = t, z.toString = function () {
            return this.description || '';
          }, z.version && U.unshift(N), z.name && U.unshift(L), H && L && (H != String(H)
            .split(' ')[0] || H != L.split(' ')[0] && !B) && U.push(B ? '(' + H + ')' : 'on ' + H), U.length && (z.description = U.join(' ')), z;
        }();
      }();
      e.exports = o;
    }).call(this, n(31));
    ...
    var d = s.fn,
      f = m.fn = m.prototype = Object.create(d);
    f.init = function () {
      d.init.call(this), u.IM.setProtocol(this), this.parser = u.IM, this.sendCmd.bind(this), this.socketUrls = [], this.syncing = !0, this.hasSynced = !1, this.hasSyncedTeamMembers = !1, this.syncPromiseArray = [], this.syncResult = {}, this.syncTeamMembersPromiseArray = [], this.syncTeamMembersResult = {}, this.timetags = {}, this.sysMsgUnread = l.completeUnread({}), this.resetUnsettledMsgs(), this.resetUnsettledSysMsgs(), this.msgPromise = Promise.resolve(), this.sysMsgPromise = Promise.resolve(), this.sessionSet = {}, this.msgReceiptTasks = {}, this.userSet = {}, this.pushNotificationMultiportConfig = c.getDefaultConfig();
    }, f.reset = function () {
      d.reset.call(this);
      var e = this.options;
    ...
    }, e.exports = m, n(435), n(434), n(433), n(427), n(425), n(424), n(423), n(422), n(421), n(420), n(419), n(418), n(417), n(416), n(415), n(414), n(413);
  }, function (e, t, n) {
    'use strict';
    var r,
      s = n(9),
    ...
    m.getInstance = function (e) {
      e = p(e), a.verifyOptions(e, 'account', 'api::Base.getInstance');
    ...
    var f = m.fn = m.prototype = Object.create(new o),
      p = function (e) {
    ...
    f.updatePrivateConf = function (e) {
      if (e && 'object' === (0, i.default)(e.privateConf)) {
        var t = e.privateConf;
        'string' == typeof t.lbs_web && (e.lbsUrl = t.lbs_web), 'boolean' == typeof t.link_ssl_web && (e.secure = t.link_ssl_web), 'boolean' == typeof t.https_enabled && (e.httpsEnabled = t.https_enabled), e.uploadUrl = t.nos_uploader_web ? t.nos_uploader_web : null, e.chunkUploadUrl = t.nos_uploader_web ? t.nos_uploader_web : null, e.replaceUrl = t.nos_downloader ? t.nos_downloader : null, e.downloadUrl = t.nos_accelerate ? t.nos_accelerate : null, e.downloadHost = t.nos_accelerate_host ? t.nos_accelerate_host : null, e.ntServerAddress = t.nt_server;
      }
      ...
      this.disconnect({
          ...
          n.logger.warn('ApiBase::destroy: instance destroyed ...'), Object.getOwnPropertyNames(n)
            .forEach(function (e) {
              delete n[e];
    ...
    var r = n(16),
      ...
      c = function () {
        var e,
          t = n(53)('iframe'),
          r = i.length;
        for (t.style.display = 'none', n(76)
          .appendChild(t), t.src = 'javascript:', (e = t.contentWindow.document).open(), e.write('<script>document.F=Object<\/script>'), e.close(), c = e.F; r--;) {
    ...
    a.init = function () {
      ...
      var t = this;
      Object.keys(this.cmdCallbackMap)
        .forEach(function (n) {
      ...
      var t = this;
      t.heartbeat(), t.parser.parseResponse(e)
        .then(function (e) {
          e.notFound && t.logger.warn('protocol::onMessage: packet not found ' + JSON.stringify(e)), e.error ? (e.error.message = e.cmd + ' error: ' + e.error.message, t.logger.error('protocol::onMessage: packet error ' + JSON.stringify(e.error))) : e.content || 'heartbeat' === e.cmd || t.logger.warn('protocol::onMessage: packet.content undefined ' + JSON.stringify(e)), e.frequencyControlDuration && (t.logger.error('protocol::onMessage: server freq control ' + JSON.stringify(e.cmd)), t.frequencyControlMap = t.frequencyControlMap || {}, t.frequencyControlMap[e.cmd] = {
            from: +new Date,
    ...
    e.exports = function (e, t, n, p, g, h, y) {
      c(n, t, p);
      var v,
        b,
        M,
        ...
        P = !1,
        I = e.prototype,
        C = I[m] || I['@@iterator'] || g && I[g],
        O = C || T(g),
        w = g ? k ? T('entries') : O : void 0,
        x = 'Array' == t && I.entries || C;
      if (x && (M = l(x.call(new e))) !== Object.prototype && M.next && (u(M, S, !0), r || 'function' == typeof M[m] || o(M, m, f)), k && C && 'values' !== C.name && (P = !0, O = function () {
        return C.call(this);
      }), r && !y || !d && !P && I[m] || o(I, m, O), a[t] = O, a[S] = f, g) {
        if (v = {
          values: k ? O : T('values'),
          keys: h ? O : T('keys'),
          entries: w,
    ...
    a.send = function () {
      ...
      if (0 === ('' + n).indexOf('2')) {
        ...
        this.onError('serverError', '服务器返回异常状态', { status: n, result: r });
      }
        ...
        genUrlSep: function (e) {
          ...
          if (n === o) {
            ...
            var m = t.path,
              d = m.indexOf('.');
            if (-1 !== d) {
              var f = m.substring(0, d),
                p = m;
              return a.replace('{bucket}', f)
                .replace('{object}', p);
            }
          }
          return e;
    ...
    e.exports = function e(t, n) {
      ...
      for (var y = 0, v = Math.max(f.length, p.length); y < v; y++) {
        if (r = !(f[y] || '').match(u) && parseFloat(f[y]) || f[y] || 0, s = !(p[y] || '').match(u) && parseFloat(p[y]) || p[y] || 0, isNaN(r) !== isNaN(s)) return isNaN(r) ? 1 : -1;
    ...
    e.exports = {
      idMap: r, cmdConfig: s, packetConfig: {
    ...
    }), f.prototype.setProtocol = function (e) {
      this.protocol = e;
    }, f.prototype.mixin = function (e) {
      var t = this;
    ...
    }, f.prototype.createCmd = (r = 1, function (e, t) {
      var n = this,
    ...
    }), f.prototype.parseResponse = function (e) {
      var t = this;
      return new Promise(function (n, r) {
        var s = JSON.parse(e),
        ...
        if (a.isNotify = l, l) {
          ...
          if (c = t.configMap.packetConfig[m.sid + '_' + m.cid], u = s.r[1].body, !c) {
            return a.notFound = {
              sid: m.sid,
              cid: m.cid,
            }, void n(a);
        ...
        if (a.service = c.service, a.cmd = c.cmd, a.error) {
          ...
          if (l && (d = m.sid + '_' + m.cid), a.error.cmd = a.cmd, a.error.callFunc = 'protocol::parseResponse: ' + d, 416 === a.error.code) {
            var f = u[0];
            f && (a.frequencyControlDuration = 1e3 * f);
          }
        }
        var p = !1;
        a.error && c.trivialErrorCodes && (p = -1 !== c.trivialErrorCodes.indexOf(a.error.code));
        var g = [];
        if ((!a.error || p) && c.response) {
          ...
          c.response.forEach(function (e, n) {
            ...
            if (!i.undef(r)) {
              ...
              switch (o) {
                case'Property':
                  g.push(t.unserialize(r, m)
                    .then(function (e, t, n, r, s) {
                      n.content[r] = s, h(e, t, n, r);
                    }.bind(this, l, s, a, c)));
                  break;
                case'PropertyArray':
                  a.content[c] = [], r.forEach(function (e) {
                    g.push(t.unserialize(e, m)
                      .then(function (e, t, n) {
                        e.content[t].push(n);
                      }.bind(this, a, c)));
                  });
    ...
    var p = ['url', 'avatar', 'fromAvatar', 'chatroomAvatar'];
    f.prototype.unserialize = function (e, t) {
      var n = this;
      return new Promise(function (r, s) {
            ...
            if (e.hasOwnProperty(c) && (o[i[c]] = e[c], !n.protocol.keepNosSafeUrl)) {
              if ('attach' === i[c] && e[c] && e[c].indexOf && ~e[c].indexOf('_im_url=1')) {
                try {
                  ...
                  n.checkObjSafeUrl(l, u, a), Promise.all(u)
                    .then(function (e, t) {
                ...
                ~p.indexOf(i[c]) && e[c] && n.matchNosSafeUrl(e[c]) && a.push(n.getOneNosOriginUrl(e[c], o, i[c]));
              }
            }
          }
        }
    ...
    }, f.prototype.syncUnserialize = function (e, t) {
      var n = this.unserializeMap[t],
        r = {};
      if (e) for (var s in n) e.hasOwnProperty(s) && (r[n[s]] = e[s]);
      return r;
    };
    var g = new f({ configMap: a, serializeMap: c, unserializeMap: u }),
      h = new f({ configMap: l, serializeMap: m, unserializeMap: d });
    ...
    var u,
      ...
      h = i.startTimer = (d = !1, function () {
        d || (d = !0, s.postMessage || (setInterval(g, 100), setInterval(p, 20)));
      });
    ...
    e.exports = !c || n(21)(function () {
      ...
      return e[n] = 7, r.split('')
        .forEach(function (e) {
          t[e] = e;
        }), 7 != c({}, e)[n] || Object.keys(c({}, t))
        .join('') != r;
    }) ? function (e, t) {
      for (var n = o(e), c = arguments.length, u = 1, l = s.f, m = i.f; c > u;) {
        for (var d, f = a(arguments[u++]), p = l ? r(f)
          .concat(l(f)) : r(f), g = p.length, h = 0; g > h;) {
          m.call(f, d = p[h++]) && (n[d] = f[d]);
        }
      }
      return n;
    } : c;
    ...
    var r = n(8),
      ...
      X = function (e, t, n) {
        return e === B && X(L, t, n), v(e), t = T(t, !0), v(n), s(D, t) ? (n.enumerable ? (s(e, U) && e[U][t] && (e[U][t] = !1), n = k(n, { enumerable: S(0, !1) })) : (s(e, U) || x(e, U, S(1, {})), e[U][t] = !0), z(e, t, n)) : x(e, t, n);
      },
      $ = function (e, t) {
        v(e);
    ...
    q || (a((_ = function () {
      ...
      return this._k;
    }), I.f = K, C.f = X, n(60).f = P.f = Q, n(28).f = G, n(38).f = Y, i && !n(35) && a(B, 'propertyIsEnumerable', G, !0), p.f = function (e) {
      return J(f(e));
    ...
    for (var te = O(f.store), ne = 0; te.length > ne;) g(te[ne++]);
    o(o.S + o.F * !q, 'Symbol', {
      for: function (e) {
    ...
    }), _.prototype[j] || n(20)(_.prototype, j, _.prototype.valueOf), m(_, 'Symbol'), m(Math, 'Math', !0), m(r.JSON, 'JSON', !0);
  }, function (e, t, n) {
    ...
    y.validTypes = Object.keys(d)
      .concat(Object.keys(h)), y.validCategories = ['team', 'friend'], y.isCustom = function (e) {
      return 'custom' === e.type;
    }, y.reverse = function (e) {
      var t = { time: +e.time, to: e.to, type: f[e.type] };
      if (c(e.from) && (t.from = e.from), c(e.idServer) && (t.idServer = '' + e.idServer), c(e.deletedIdClient) && (t.deletedIdClient = e.deletedIdClient), c(e.deletedIdServer) && (t.deletedIdServer = '' + e.deletedIdServer), c(e.deletedMsgTime) && (t.deletedMsgTime = +e.deletedMsgTime), c(e.deletedMsgFromNick) && (t.deletedMsgFromNick = '' + e.deletedMsgFromNick), c(e.opeAccount) && (t.opeAccount = e.opeAccount), c(e.ps) && (t.ps = e.ps), e.attach = e.attach ? '' + e.attach : '', 'customP2p' === t.type || 'customTeam' === t.type) {
        t.content = e.attach, c(e.apnsText) && (t.apnsText = e.apnsText), c(e.pushPayload) && (t.pushPayload = e.pushPayload), o.merge(t, {
          sendToOnlineUsersOnly: a(e.sendToOnlineUsersOnly) || 0 == +e.sendToOnlineUsersOnly,
          cc: a(e.cc) || 1 == +e.cc,
          isPushable: a(e.isPushable) || 1 == +e.isPushable,
          isUnreadable: a(e.isUnreadable) || 1 == +e.isUnreadable,
          needPushNick: c(e.needPushNick) && 1 == +e.needPushNick,
        }), t.scene = t.type.slice(6)
          .toLowerCase(), t.type = 'custom';
      } else if ('deleteMsgP2p' === t.type || 'deleteMsgTeam' === t.type) {
        t.scene = t.type.slice(9)
          .toLowerCase(), t.type = 'deleteMsg';
      } else {
        if (e.attach) {
          t.attach = {};
          var n = JSON.parse(e.attach);
          c(n.vt) ? (t.type = p[n.vt], delete t.attach) : (c(n.tinfo) && (t.attach.team = l.reverse(u.syncUnserialize(n.tinfo, 'team'))), c(n.tlist) && (t.attach.member = m.reverse(u.syncUnserialize(n.tlist, 'teamMember'))), c(n.attach) && (t.attach.custom = n.attach));
        }
    ...
    function b(e) {
      switch (r.verifyOptions(e, 'action', 'team::Team'), e.action) {
        case'create':
          r.verifyOptions(e, 'teamId', !1, 'team::Team'), r.verifyOptions(e, 'type name', 'team::Team'), r.verifyParamValid('type', e.type, f, 'team::Team'), s(e.level) && (r.verifyParamType('level', e.level, 'number', 'team::Team'), this.level = e.level);
          break;
        case'update':
    ...
    c.updateCustomMode = {
      ...
      var n = r.copy(e);
      if (s(n.teamId) && (n.teamId = '' + n.teamId), s(n.type) && (n.type = d[n.type]), s(n.level) && (n.level = +n.level), s(n.valid) && (n.valid = 1 == +n.valid), s(n.memberNum) && (n.memberNum = +n.memberNum), s(n.memberUpdateTime) && (n.memberUpdateTime = +n.memberUpdateTime), s(n.createTime) && (n.createTime = +n.createTime), s(n.updateTime) && (n.updateTime = +n.updateTime), s(n.validToCurrentUser) && (n.validToCurrentUser = '1' === n.validToCurrentUser), s(n.mute) && (n.mute = '1' === n.mute), s(n.muteType)) {
        switch (n.muteType) {
          case'0':
        ...
        s(n.mute) && (1 === n.mute ? (n.mute = !0, n.muteType = 'normal') : (n.mute = !1, n.muteType = 'none'));
      }
    ...
    a.prototype = Object.create(s.prototype), a.reverse = function (e) {
      var t = s.reverse(e);
      return e.attach = e.attach ? '' + e.attach : '', t.file = e.attach ? JSON.parse(e.attach) : {}, t.file.url = (0, r.genPrivateUrl)(t.file.url), 'audio' !== t.type || t.file.mp3Url || (t.file.mp3Url = t.file.url + (~t.file.url.indexOf('?') ? '&' : '?') + 'audioTrans&type=mp3'), o.httpsEnabled && (t.file.url = t.file.url.replace('http', 'https')), t;
    }, e.exports = a;
    var c = n(410),
      u = n(409),
      l = n(408);
    ...
    e.exports = function (e, t, n) {
      ...
      function a(t) {
        ...
        if (parseInt(r) >= 100 && (r = 100, a = function () {
        }), o.percentage !== r) {
          o.percentage = r;
          var s = {
            docId: e.docId,
      ...
      function c(t) {
        ...
        if (t.errMsg || t.errCode) {
          ...
          delete l.onaftersend, o.fileUoloadedSize = t.offset, n.sn = function (e, t, n, r, o) {
            var l = t.offset,
              m = t.offset + s;
      ...
      function u(e) {
        try {
          if (e.result) var t = JSON.parse(e.result); else t = e;
          n.onError(t);
        } catch (e) {
          n.onError(e);
        }
    ...
    u.init = function () {
      ...
      if (r.isArray(i)) {
        ...
        if (!i) {
          return o[n] = [this.doSend.bind(this, e)], void r.createIframe({
            src: n,
            onload: function (e) {
              var t = o[n];
 ...
 */
    ...
    a.doSend = function () {
      ...
      if ('multipart/form-data' === t['Content-Type']) {
        ...
        var s = e.data;
        e.data = new window.FormData, s && r.getKeys(s, e.putFileAtEnd)
          .forEach(function (t) {
            var n = s[t];
        ...
        t['x-nos-token'] && (n.upload.onprogress = this.onProgress.bind(this), n.upload.onload = this.onProgress.bind(this));
      }
      n.onreadystatechange = this.onStateChange.bind(this), 0 !== e.timeout && (this.timer = setTimeout(this.onTimeout.bind(this), e.timeout)), n.open(e.method, e.url, !e.sync), Object.keys(t)
        .forEach(function (e) {
      ...
      void 0 === root.location && (root.location = null), root.io ? module && (module.exports = io = root.io) : root.io = io, function () {
        !function (e, t) {
          ...
          n.load = function (e) {
            ...
            if (!e) {
              try {
                return new (root[['Active'].concat('Object')
          ...
          n.encodePacket = function (e) {
            ...
            switch (e.type) {
              ...
              case'event':
                var f = { name: e.name };
                e.args && e.args.length && (f.args = e.args), l = o.stringify(f);
                break;
              case'json':
          ...
          e.Socket = r, t.util.mixin(r, t.EventEmitter), r.prototype.of = function (e) {
            ...
            return (this.connected || this.connecting) && (this.open && this.of('')
              .packet({ type: 'disconnect' }), this.onDisconnect('booted')), this;
    ...
    var r = n(0),
      ...
      o = r.merge({}, s.cmdConfig, {
        ...
        updatePushToken: {
          ...
          params: [{ type: 'String', name: 'tokenName' }, {
            type: 'String',
            name: 'token',
        ...
        appBackground: {
          ...
          params: [{ type: 'bool', name: 'isBackground' }, {
            type: 'Int',
            name: 'badge',
          }],
        },
        ...
        searchHistoryMsgs: {
          ...
          params: [{ type: 'String', name: 'to' }, {
            ...
            type: 'String',
            name: 'keyword',
          }, { type: 'int', name: 'limit' }, { type: 'bool', name: 'reverse' }],
        },
        getSessions: {
          sid: i.msg.id,
        ...
        addTeamMembers: {
          ...
          params: [{ type: 'long', name: 'teamId' }, {
            type: 'StrArray',
            name: 'accounts',
          }, { type: 'String', name: 'ps' }, { type: 'String', name: 'attach' }],
        },
        removeTeamMembers: {
          sid: i.team.id,
      ...
      a = r.merge({}, s.packetConfig, {
        ...
        '2_5': {
          service: 'auth',
          cmd: 'kicked',
          response: [{ type: 'Number', name: 'from' }, {
            type: 'Number',
            name: 'reason',
          }],
        },
        ...
        '3_115': {
          ...
          response: [{ type: 'Property', name: 'donnop' }, {
            type: 'Number',
            name: 'timetag',
          }],
        },
        ...
        '4_14': {
          service: 'notify',
          cmd: 'syncSessionAck',
          response: [{ type: 'StrLongMap', name: 'p2p' }, {
            type: 'LongLongMap',
            name: 'team',
          }, { type: 'Number', name: 'timetag' }],
        },
        ...
        '7_116': {
          ...
          response: [{ type: 'Number', name: 'scene' }, {
            type: 'String',
            name: 'to',
          }, { type: 'Number', name: 'timetag' }],
        },
 ...
 */
      ...
      r = function () {
        ...
        function A(t, n, r) {
          n.constructor === t.constructor && r === T && n.constructor.resolve === S ? function (e, t) {
            t._state === C ? R(e, t._result) : t._state === O ? U(e, t._result) : j(t, void 0, function (t) {
              return _(e, t);
            }, function (t) {
              return U(e, t);
            });
          }(t, n) : r === w ? (U(t, w.error), w.error = null) : void 0 === r ? R(t, n) : e(r) ? function (e, t, n) {
            a(function (e) {
              var r = !1,
                s = function (e, t, n, r) {
                  try {
        ...
        function _(e, t) {
          var n,
            r;
          e === t ? U(e, new TypeError('You cannot resolve a promise with itself')) : (r = typeof (n = t), null === n || 'object' !== r && 'function' !== r ? R(e, t) : A(e, t, x(t)));
        }
        ...
        function R(e, t) {
          e._state === I && (e._result = t, e._state = C, 0 !== e._subscribers.length && a(F, e));
        }
        ...
        function j(e, t, n, r) {
          var s = e._subscribers,
            i = s.length;
          e._onerror = null, s[i] = t, s[i + C] = n, s[i + O] = r, 0 === i && e._state && a(F, e);
        }
        ...
        function N(t, n, r, s) {
          ...
          if (i) {
            ...
            }(r, s)) === w ? (u = !0, a = o.error, o.error = null) : c = !0, n === o) {
              return void U(n, new TypeError('A promises callback cannot return that same promise.'));
            }
          } else {
            o = s, c = !0;
          }
          n._state !== I || (i && c ? _(n, o) : u ? U(n, a) : t === C ? R(n, o) : t === O && U(n, o));
        }
        ...
        var B = function () {
          function e(e, t) {
            this._instanceConstructor = e, this.promise = new e(P), this.promise[k] || L(this.promise), r(t) ? (this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? R(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(t), 0 === this._remaining && R(this.promise, this._result))) : U(this.promise, new Error('Array Methods must be provided an Array'));
          }
    ...
    function u(e) {
      ...
      if ('json' in e && !1 !== e.json && (h = !0, p.accept || p.Accept || (p.Accept = 'application/json'), 'GET' !== d && 'HEAD' !== d && (p['content-type'] || p['Content-Type'] || (p['Content-Type'] = 'application/json'), f = JSON.stringify(!0 === e.json ? f : e.json))), u.onreadystatechange = function () {
    ...
    var r = n(0),
      ...
      o = r.merge({}, s.cmdConfig, {
        ...
        updateChatroom: {
          ...
          params: [{ type: 'Property', name: 'chatroom' }, {
            type: 'bool',
            name: 'needNotify',
          }, { type: 'String', name: 'custom' }],
        },
        ...
        queueChange: {
          ...
          params: [{ type: 'StrStrMap', name: 'elementMap' }, {
            type: 'bool',
            name: 'needNotify',
      ...
      a = r.merge({}, s.packetConfig, {
        ...
        '13_3': {
          service: 'chatroom',
          cmd: 'kicked',
          response: [{ type: 'Number', name: 'reason' }, {
            type: 'String',
            name: 'custom',
          }],
        },
        ...
        '13_21': {
          service: 'chatroom',
          cmd: 'queuePoll',
          response: [{ type: 'String', name: 'elementKey' }, {
            type: 'String',
            name: 'elementValue',
          }],
        },
    ...
    a.login = function () {
      ...
      if (p(n) && (i.from = l.reverseType(n)), p(s) && (i.custom = s), this.shouldNotifyKicked(i)) {
        var o = new c('被踢了', 'kicked');
        f.merge(o, i), this.onAuthError(o, 'link::onKicked');
      } else {
        this.logger.warn('link::onKicked: silentlyKick'), this.shouldReconnect = !0, this.hasNotifyDisconnected = !0, this.disconnectSocket();
      }
    ...
    r.initConnect = function () {
      ...
      } else if (this.connecting = !0, this.hasNotifyDisconnected = !1, this.socket && this.socket && this.socket.socket) {
      ...
      if (e.willReconnect()) {
        if (e.socket && e.socket.socket && e.socket.socket.transport && e.socket.socket.transport.websocket) {
          ...
          clearTimeout(e.reconnectTimer), e.reconnectTimer = setTimeout(function () {
    ...
    o.signalingCreate = function () {
      ...
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
      return a.verifyOptions(e, 'channelId', 'api::signalling'), this.sendCmdUsePromise('signalingDelay', { avSignalTag: e })
        .then(function (e) {
          var t = e.avSignalTag;
          return Promise.resolve(t);
        })
      ...
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        t = e.offlineEnabled;
      return a.verifyOptions(e, 'channelId', 'api::signalling'), this.sendCmdUsePromise('signalingClose', { avSignalTag: a.merge(e, { isSave: !0 === t ? 1 : 0 }) })
        .then(function (e) {
          var t = e.avSignalTag;
      ...
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        t = e.offlineEnabled;
      return a.verifyOptions(e, 'channelId', 'api::signalling'), this.sendCmdUsePromise('signalingJoin', { avSignalTag: a.merge(e, { isSave: !0 === t ? 1 : 0 }) })
        .then(function (e) {
          var t = e.avSignalTag,
            n = t.members;
          return 'string' == typeof t.members && (n = JSON.parse(t.members)
            .map(function (e) {
      ...
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        t = e.offlineEnabled;
      return a.verifyOptions(e, 'channelId', 'api::signalling'), this.sendCmdUsePromise('signalingLeave', { avSignalTag: a.merge(e, { isSave: !0 === t ? 1 : 0 }) })
        .then(function (e) {
          var t = e.avSignalTag;
          return t.offlineEnabled = 1 === t.isSave, delete t.isSave, Promise.resolve(t);
        })
      ...
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        t = e.channelName;
      return a.verifyOptions(e, 'channelName', 'api::signalling'), this.sendCmdUsePromise('signalingGetChannelInfo', { avSignalTag: { channelName: t } })
        .then(function (e) {
          var t = e.avSignalTag;
          return Promise.resolve(t);
        })
      ...
      var i = '';
      return this.signalingCreateAndJoin(e)
        .then(function (o) {
      ...
      var t = e.account;
      return a.verifyOptions(e, 'channelId', 'api::signalling'), this.sendCmdUsePromise('signalingControl', { avSignalTag: a.merge(e, t ? { to: t } : {}) })
        .then(function (e) {
          var t = e.avSignalTag;
          return Promise.resolve(t);
        })
    ...
    i.transDoc = function (e) {
      ...
      var o = JSON.stringify(a.genResponseBody('file') || {})
          .replace(/"/gi, '\\"'),
        u = {
          transToken: {
            name: n,
      ...
      var n = e.ops.map(function (e) {
        return s.verifyOptions(e, 'type', !0, '', 'nos::processImage'), s.verifyParamValid('type', e.type, o.validTypes, 'nos::processImage'), t['gen' + e.type.slice(0, 1)
          .toUpperCase() + e.type.slice(1) + 'Op'](e);
      });
    ...
    function l(e) {
      ...
      if (u) {
        if (c) {
          ...
          if (e.fileInputMaxSize && m > e.fileInputMaxSize) return void e.uploaddone(i.newFileTooLargeError('上传文件大小超过' + e.fileInputMaxSize + '限制'));
          if (!e.fileInputCommonUpload) return m > r.chunkMaxSize ? void e.uploaddone(i.newFileTooLargeError('直传文件大小超过' + r.chunkMaxSize + '限制')) : void (t.sn = a(e, n, t));
          if (m > r.commonMaxSize) return void e.uploaddone(i.newFileTooLargeError('普通上传文件大小超过' + r.commonMaxSize + '限制'));
        } else {
          e.blob && (e.data[n] = e.blob);
        }
      } else {
        s.dataset(c, 'name', n), e.data.input = c;
      }
      var d = {
        ...
        return function (t) {
          t = t || {}, function () {
            ...
            'function' != typeof Date.prototype.toISOString && (Date.prototype.toISOString = function () {
              return this.getUTCFullYear() + '-' + e(this.getUTCMonth() + 1) + '-' + e(this.getUTCDate()) + 'T' + e(this.getUTCHours()) + ':' + e(this.getUTCMinutes()) + ':' + e(this.getUTCSeconds()) + '.' + String((this.getUTCMilliseconds() / 1e3).toFixed(3))
                .slice(2, 5) + 'Z';
            });
          }();
          var n = {
          ...
          function a(e, s) {
            ...
            for (var f = 0; f < e.attributes.length; f++) {
              ...
              a.__cnt++;
              for (var g = p.value, h = 0; h < t.attributeConverters.length; h++) {
                var y = t.attributeConverters[h];
                y.test.call(null, p.name, p.value) && (g = y.convert.call(null, p.name, p.value));
              }
              a[t.attributePrefix + p.name] = g;
            }
            var v = e.prefix;
            return v && (a.__cnt++, a.__prefix = v), a['#text'] && (a.__text = a['#text'], a.__text instanceof Array && (a.__text = a.__text.join('\n')), t.escapeMode && (a.__text = a.__text.replace(/&lt;/g, '<')
              ...
              .replace(/&quot;/g, '"')
              .replace(/&#x27;/g, '\'')
              .replace(/&amp;/g, '&')), t.stripWhitespaces && (a.__text = a.__text.trim()), delete a['#text'], 'property' === t.arrayAccessForm && delete a['#text_asArray'], a.__text = function (e, n, r) {
          ...
          function m(e, n) {
            return 'property' === t.arrayAccessForm && (r = n.toString(), s = '_asArray', -1 !== r.indexOf(s, r.length - s.length)) || 0 === n.toString()
              .indexOf(t.attributePrefix) || 0 === n.toString()
          ...
          function f(e) {
            ...
            if (e instanceof Object) {
              for (var r in e) {
                -1 === r.toString()
                  .indexOf('__') && 0 === r.toString()
                  .indexOf(t.attributePrefix) && n.push(r);
              }
            }
            return n;
          }
            ...
            if (t.jsAttributeConverter && (e = t.jsAttributeConverter.call(null, n, e)), null != e && '' !== e || !t.selfClosingElements) {
              if ('object' == typeof e) {
                if ('[object Array]' === Object.prototype.toString.call(e)) {
                  s += function (e, t, n) {
                    var r = '';
                    if (0 === e.length) r += u(e, t, n, !0); else for (var s = 0; s < e.length; s++) r += g(e[s], t, f(e[s]));
                    return r;
                  }(e, n, r);
                } else if (e instanceof Date) {
                  s += u(e, n, r, !1), s += t.jsDateUTC ? e.toUTCString() : e.toISOString(), s += l(e, n);
                } else {
                  var i = d(e);
                  i > 0 || e.__text || e.__cdata ? (s += u(e, n, r, !1), s += h(e), s += l(e, n)) : t.selfClosingElements ? s += u(e, n, r, !0) : (s += u(e, n, r, !1), s += l(e, n));
                }
              } else {
                s += u(e, n, r, !1), s += p(e), s += l(e, n);
              }
            } else {
              s += u(e, n, r, !0);
            }
          ...
          function y(t) {
            ...
            var n = null,
              r = null;
            if (e) {
              n = new e, r = n.parseFromString(t, 'text/xml');
              ...
              0 === t.indexOf('<?') && (t = t.substr(t.indexOf('?>') + 2)), (r = new ActiveXObject('Microsoft.XMLDOM')).async = 'false', r.loadXML(t);
            }
            return r;
          }
    ...
    o.sendText = function (e) {
      ...
      if (a.verifyOptions(e, 'done', 'msg::previewFile'), e.type || (e.type = 'file'), a.verifyParamPresentJustOne(e, 'dataURL blob fileInput filePath wxFilePath fileObject', 'msg::previewFile'), a.exist(e.fileInputMaxSize) && a.verifyParamType('fileInputMaxSize', e.fileInputMaxSize, 'number', 'api::previewFile'), a.exist(e.fileInputCommonUpload) && a.verifyParamType('fileInputCommonUpload', e.fileInputCommonUpload, 'boolean', 'api::previewFile'), e.nosSurvivalTime ? (a.verifyParamType('nosSurvivalTime', e.nosSurvivalTime, 'number', 'api::Base.getInstance'), a.verifyParamMin('nosSurvivalTime', e.nosSurvivalTime, 86400, 'api::Base.getInstance')) : e.nosSurvivalTime = this.nosSurvivalTime, e.filePath = e.filePath || e.wxFilePath, delete e.wxFilePath, e.dataURL) {
        e.blob = f.fromDataURL(e.dataURL);
      } else if (e.blob) {
        ;
      } else if (e.fileInput) {
      ...
      var t = JSON.stringify(m.genResponseBody(e.type) || {})
          .replace(/"/gi, '\\"'),
        n = null,
      ...
      e.fileInputCommonUpload || e.dataURL || e.blob || !o || l.isWeixinApp || l.isNodejs || l.isRN ? (e.fileInputCommonUpload = !0, t = s) : t = o;
      ...
      function f(t, s, i) {
        if (e.uploaddone = r, t) {
          ...
          if (s = m.parseResponse(s, n.options.exifOrientation), i || (s.url = l.genDownloadUrl(e.nosToken, c.Object), e.nosToken.shortUrl && (s._url_safe = e.nosToken.shortUrl)), a.exist(e.fileInputName)) {
      ...
      if (l.isWeixinApp) {
        a.verifyOptions(e, 'filePath', 'msg::_doPreviewFile'), n.fileQuickTransfer(e, f, function () {
          wx.uploadFile({
            url: t,
            filePath: e.filePath,
            name: 'file',
            ...
            success: function (e) {
              if (200 === e.statusCode) {
                try {
                  f(null, JSON.parse(e.data));
                } catch (t) {
                  console.log('error:', 'parse wx upload file res error', t), f({
                ...
                f({ code: e.statusCode, msg: e.errMsg });
              }
            },
          });
        });
        ...
        var p = {
          url: t, name: 'file', formData: c, success: function (e) {
            if (200 === e.statusCode) {
              try {
                f(null, JSON.parse(e.data));
              } catch (t) {
                console.log('error:', 'parse nodejs upload file res error', t), f({
        ...
        if (e.filePath) {
          ...
          p.fileData = e.fileObject.fileData;
        }
        n.fileQuickTransfer(e, f, function () {
          d.uploadFile(p);
        });
      } else if (l.isRN) {
        var g = {
          ...
          success: function (e) {
            if (e.ok && 200 === e.status) {
              try {
                e.md5 = e.headers.map && e.headers.map.etag && e.headers.map.etag[0] || 'UNKNOWN', f(null, e);
              } catch (t) {
                console.log('error:', 'parse React Native upload file res error', t), f({
                  code: 'PARSE_React_Native_UPLOAD_FILE_RES_ERROR',
                  res: e,
                });
              }
            } else {
              f({ code: e.status, msg: e.statusText });
            }
          },
          fail: function (e) {
            console.log('error:', 'api::msg:upload file failed', e);
        ...
        e.uploaddone = f, e.url = t, e.params = c, e.fileName = 'file', n.fileQuickTransfer(e, f, function () {
          return new d(e);
        });
      }
      ...
      if (e.type || (e.type = 'file'), a.verifyParamPresentJustOne(e, 'dataURL blob fileInput file filePath wxFilePath fileObject', 'msg::sendFile'), a.exist(e.fileInputMaxSize) && a.verifyParamType('fileInputMaxSize', e.fileInputMaxSize, 'number', 'api::previewFile'), a.exist(e.fileInputCommonUpload) && a.verifyParamType('fileInputCommonUpload', e.fileInputCommonUpload, 'boolean', 'api::previewFile'), this.processCallback(e), e.filePath = e.filePath || e.wxFilePath, delete e.wxFilePath, e.dataURL) {
    ...
    r.markSysMsgRead = function (e) {
      ...
      s.isArray(o) || (o = [o]), n.enable ? r = n.markSysMsgRead(o)
        .then(function (e) {
      ...
      s.verifyOptions(e, 'idServer', 'sysmsg::deleteLocalSysMsg'), this.processCallback(e), n.enable ? n.deleteSysMsg(e.idServer)
        .then(function () {
          r();
        }, function (e) {
          t = e, r();
      ...
      n.processCallback(e), r.enable && r.deleteAllSysMsgs()
        .then(function () {
          s();
        }, function (e) {
          t = e, s();
    ...
    r.getHistoryMsgs = function (e) {
      ...
      o(e.end) && (c = !0, s.verifyParamType('end', e.end, 'number', 'msg::getLocalMsgs')), a && c && e.end <= e.start && s.onParamError('参数 end 必须晚于 start'), i(e.limit) && (e.limit = 100), s.verifyParamType('limit', e.limit, 'number', 'msg::getLocalMsgs'), s.verifyParamMin('limit', e.limit, 1, 'msg::getLocalMsgs'), this.processCallback(e), t.enable ? t.getMsgs(e)
        .then(function (e) {
          r = e, u();
        }, function (e) {
      ...
      s.verifyOptions(e, 'idClient', 'msg::getLocalMsgByIdClient'), this.processCallback(e), n.enable ? n.getMsgByIdClient(e.idClient)
        .then(function (e) {
          e && (r = e), i();
        }, function (e) {
          t = e, i();
      ...
      s.verifyOptions(e, 'idClients', 'msg::getLocalMsgByIdClient'), s.verifyParamType('idClients', e.idClients, 'array', 'msg::getLocalMsgByIdClient'), this.processCallback(e), n.enable ? n.getMsgsByIdClients(e.idClients)
        .then(function (e) {
      ...
      s.verifyOptions(n, 'idClient sessionId', !0, 'msg.', 'msg::deleteLocalMsg'), this.processCallback(e), this.protocol.deleteLocalMsg(n)
        .then(r, function (e) {
          t = e, r();
        });
      ...
      s.verifyOptions(e, 'scene to', 'msg::deleteLocalMsgsBySession'), s.verifyParamValid('scene', e.scene, this.message.validScenes, 'msg::deleteLocalMsgsBySession'), e.sessionId = e.scene + '-' + e.to, this.processCallback(e), n.enable ? n.deleteMsgsBySessionId(e.sessionId)
        .then(function () {
          r();
        }, function (e) {
          t = e, r();
      ...
      this.processCallback(e), n.enable && n.deleteAllMsgs()
        .then(function () {
          r();
        }, function (e) {
          t = e, r();
    ...
    r.setCurrSession = function (e) {
      ...
      s.verifyOptions(e, 'scene to', 'scene::insertLocalSession'), s.verifyParamValid('scene', e.scene, this.message.validScenes, 'scene::insertLocalSession'), this.processCallback(e), this.protocol.insertLocalSession(e)
        .then(function (e) {
          n = e, r();
        }, function (e) {
          t = e, r();
      ...
      if (s.verifyOptions(e, 'sessionId', 'scene::getLocalSession'), s.verifyParamType('sessionId', e.sessionId, 'string', 'scene::getLocalSession'), n.enable) {
        return this.processCallback(e), void n.getSession(e.sessionId)
          .then(function (e) {
            e && (r = e), i();
          }, function (e) {
            t = e, i();
      ...
      s.verifyOptions(e, 'id', 'session::deleteLocalSession'), n.processCallback(e), r.enable ? r.deleteSession(e.id)
        .then(function () {
    ...
    r.createTeam = function (e) {
      ...
      }, t = e.teamId, r.enable && !e.sync ? r.getTeam(t)
        .then(function (r) {
      ...
      s.verifyOptions(e), t.processCallback(e), n.enable ? n.getTeamsTimetag()
        .then(function (e) {
          r = e, i();
        }, i) : i();
      ...
      s.verifyOptions(e, 'teamIds', 'team::getLocalTeams'), s.verifyParamType('teamIds', e.teamIds, 'array', 'team::getLocalTeams'), this.processCallback(e), n.enable ? n.getTeamsByTeamIds(e.teamIds)
        .then(function (e) {
          r = e.filter(function (e) {
            return !!e;
          }), i();
      ...
      s.verifyOptions(e, 'teamId accounts', 'team::getLocalTeamMembers'), s.verifyParamType('accounts', e.accounts, 'array', 'team::getLocalTeamMembers'), this.processCallback(e), n.enable ? n.getInvalidTeamMembers(e.teamId, e.accounts)
        .then(function (e) {
          r = e.filter(function (e) {
            return !!e;
          }), i();
      ...
      s.verifyOptions(e, 'teamId', 'team::deleteLocalTeam'), this.processCallback(e), n.enable ? n.deleteTeam(e.teamId)
        .then(function () {
          r();
        }, function (e) {
          t = e, r();
    ...
    r.friendRequest = function (e) {
      ...
      s.verifyOptions(e), t.processCallback(e), n.enable ? n.getFriendsTimetag()
        .then(function (e) {
          r = e, i();
        }, i) : i();
    };
    ...
    r.updateMyInfo = function (e) {
      ...
      }, t = e.account, e.sync ? i() : r.enable ? r.getUser(t)
        .then(function (r) {
      ...
      }, t = s.deduplicate(e.accounts), s.verifyArrayMax('accounts', e.accounts, 150, 'user::getUsers'), e.sync ? a() : r.enable ? r.getUsers(t)
        .then(function (r) {
    ...
    r.markInBlacklist = function (e) {
      ...
      e = s.verifyOptions(e), t.processCallback(e), n.enable ? n.getRelationsTimetag()
        .then(function (e) {
          r = e, i();
        }, i) : i();
    };
    ...
    r.mergeSession = function (e) {
      ...
      if (n.findSession(e)) {
        ...
        n.logger.warn('session::resetSessionUnread: no session ' + e);
      }
    }, r.insertLocalSession = function (e) {
      var t = this,
        n = t.db,
      ...
      return new Promise(function (a, c) {
        ...
        if (d) {
          ...
          var f;
          if (s.isNumber(e.updateTime)) {
            f = e.updateTime;
          } else {
            var p,
              g = [];
            for (var h in r) r.hasOwnProperty(h) && (p = r[h], s.isNumber(p.updateTime) && g.push(p.updateTime));
            f = Math.max.apply(Math, g) + 1, f = Math.max(f, +new Date);
          }
          ...
          n.enable && (y = n.getMsgs({
            ...
            if (s.isArray(e) && 1 === e.length) {
              var r = e[0];
              (d = i.genSessionByMsg(r)).updateTime = f;
            } else {
              d = { id: m, scene: u, to: l, updateTime: f, lastMsg: null };
            }
            n.enable ? n.putSession(d)
              .then(a, c) : a(d), t.onUpdateSession(d);
          });
        }
      });
    ...
    r.splitSysMsgs = function (e, t) {
      ...
      if (r.length) {
        var c = n.putSysMsg(r, 'offlineSysMsgs')
          .then(function (e) {
      ...
      return (o = (o = o.then(function () {
        ...
        return n.getSysMsgUnread()
          .then(function (r) {
            return a.length || ((a = e).backward = !0), n.updateSysMsgUnread(a, r, 1)
              .then(function (e) {
    ...
    r.onDeleteMsg = function (e) {
      ...
      delete e.obj.sysMsg, e.error || (e.promise = this.deleteLocalMsg(e.obj.msg)
        .then(function () {
          var n = e.obj.msg;
          t.enable && t.getTimetag('deleteMsg')
            .then(function (e) {
      ...
      if (!e.error) {
        ...
        r = t.processDeleteMsgSysMsg(r), t.markSysMsgRead(r), t.deleteLocalMsg(r.msg)
          .then(function () {
      ...
      if (n.enable && e) {
        var s = !1,
          i = null,
          o = e.sessionId;
        return n.getMsgs({ sessionId: o, limit: 1 })
          .then(function (t) {
    ...
    r.onOfflineMsgReceipts = function (e) {
      ...
      s.forEach(function (e) {
        ...
        var u = c[s];
        r.enable ? t = r.getSession(s)
          .then(function (t) {
            if ((t = t || u) && n.shouldUpdateSessionFromMsgReceipt(t, e)) {
              var i = n.genSessionFromMsgReceipt(t, e),
                o = n.syncResult.sessions;
              return o && o[s] && (o = o[s]).lastMsg && i.lastMsg && o.lastMsg.time > i.lastMsg.time && (i.lastMsg = o.lastMsg), r.putSession(i)
                .then(function (e) {
    ...
    r.processMsg = function (e) {
      ...
      function d(e) {
        if (u.length) {
          ...
          n.cacheSyncedSession(o), (a = n.putMsg(u, 'offlineMsgs')
            .then(function (s) {
      ...
      return n.checkIgnore(e), n.logger.log('start'), a = (a = (a = a.then(function () {
        ...
        .then(function (t) {
          ...
          }), e = r, f = o ? t : e, Promise.resolve(e);
        })).then(function (e) {
        return e.length && (p(m = n.genSessionByMsgs(e)), o && m) ? new Promise(function (t, s) {
          r.getSessions({ sessionId: m.id })
            .then(function (s) {
              if (s && s.lastMsg) {
                var i = s.lastMsg;
                m.lastMsg && m.lastMsg.time < i.time && (m.lastMsg = i);
              }
              n.logger.log('msg::putMsg:db.getSessions: ', m), f.length ? m ? r.putSession(m)
                .then(function (e) {
                  t(e);
                }) : t(s) : (d = !0, f = e, t(s));
            });
        ...
        if (m && f.length) {
          ...
          if ('offlineMsgs' === t || s && a || 'onMsg' === t && 'in' === u && l) {
            o && e ? (m = e, h = h || m.ack || 0) : (e = g) && (m.unread = e.unread || 0), p(m), m.unread = m.unread || 0;
            var y = 0;
            ...
            }), console.log(m), m.unread += y, n.logger.log('msg::putMsg:updateSession: ', m), p(m), o && !d) {
      ...
      if (r > 0) {
        if (t.doMarkBroadcastMsgsRead(e), n.enable) {
          ...
          return n.updateBroadcastMsgTimetag(i), n.putBroadcastMsg(e)
            .then(function () {
              return setTimeout(function () {
      ...
      var t = this,
        n = t.db;
      return t.doMarkBroadcastMsgsRead([e]), n.enable ? (e.broadcastId && n.updateBroadcastMsgTimetag(e.broadcastId), n.putBroadcastMsg(e)
        .then(function () {
          return setTimeout(function () {
      ...
      if (e.obj) {
        ...
        var s = n.db;
        s && s.enable && s.getMsgByIdClient(r.idClient)
          .then(function (e) {
            e && (r = e, i());
          }, function (e) {
            i();
      ...
      function i() {
        ...
        e.error && !s || (r.idServer = e.content.msg.idServer, r.time = +e.content.msg.time), e.error ? r.status = 'fail' : r.status = 'success', r = n.message.reverse(r), t && (r.filter = !0), e.obj = r, n.syncing ? n.unupdatedMsgs.push(r) : n.msgPromise = Promise.all([n.msgPromise, e.obj.promise])
          .then(function (e) {
    ...
    r.processTeam = function (e) {
      ...
      var m = new Promise(function (m, f) {
        var p,
          g;
        e.error ? s && f(e.error) : (!function () {
        ...
        }(), r.enable ? (p = m, g = f, e.promise = new Promise(function (e, i) {
          function o() {
            s ? (d(), e(), p()) : r.getTeams()
              .then(function (t) {
                u = t, d(), e(), p();
    ...
    r.processFriend = function (e) {
      ...
      var t,
        ...
        d = new Promise(function (d, p) {
          ...
          }(), r.enable ? (g = d, h = p, e.promise = new Promise(function (e, s) {
            function i() {
              a ? (f(), e(), g()) : r.getFriends()
                .then(function (t) {
                  l = t, f(), e(), g();
                })
                .then(void 0, function (e) {
      ...
      if (e.obj.idServer) {
        if (i) {
          t = 'error', i = s.filterObj(i, 'code message');
        } else {
          var a = r.type;
    ...
    r.processUser = function (e) {
      ...
      var t = this,
        ...
        c = new Promise(function (e, c) {
          var l,
            m;
          r ? i && (r && (r.callFunc = 'user::onMyInfo'), e(r), t.syncData()) : (o = a.reverse(s.user), t.logger.info('user::onMyInfo: parseData', o), n.enable ? (l = e, m = c, n.mergeMyInfo(o, i)
            .then(function () {
              u(), l();
            })
            .then(void 0, function (e) {
      ...
      var t = this,
        ...
        d = [],
        f = [],
        p = new Promise(function (p, h) {
          var y,
            v;
          r ? s && (p(r), t.syncData()) : (a.forEach(function (e) {
            var t = {
              account: (e = o.parse(e)).account,
              createTime: e.createTime,
              updateTime: e.updateTime,
            };
            e.isBlacked ? l.push(t) : m.push(t), e.isMuted ? d.push(t) : f.push(t);
          }), t.logger.info('user::onRelations: parse blacklist', i(l), l, 'delete', i(m), m), t.logger.info('user::onRelations: parse mutelist', i(d), d, 'delete', i(f), f), a.length ? (c = !0, u = e.content.timetag) : c = !1, n.enable ? (y = p, v = h, e.promise = new Promise(function (e, r) {
            function i() {
              s ? (g(), e(), y()) : n.getRelations()
                .then(function (t) {
                  l = t[0], d = t[1], g(), e(), y();
                })
                .then(void 0, function (e) {
      ...
      function g() {
        t.timetags.relations = u, l.invalid = m, d.invalid = f, s ? (t.syncResult.blacklist = l, t.syncResult.mutelist = d, t.syncResult.invalidBlacklist = m, t.syncResult.invalidMutelist = f) : (t.logger.info('user::onRelations: get relations', l, d), e.obj.blacklist = l, e.obj.mutelist = d);
      }

      s && (p.cmd = 'relations', t.syncPromiseArray.push(p));
    ...
    s(s.S + s.F * !n(130)(function (e) {
      ...
      from: function (e) {
        var t,
          ...
          y = 0,
          v = l(d);
        if (h && (g = r(g, p > 2 ? arguments[2] : void 0, 2)), null == v || f == Array && a(v)) for (n = new f(t = c(d.length)); t > y; y++) u(n, y, h ? g(d[y], y) : d[y]); else for (m = v.call(d), n = new f; !(s = m.next()).done; y++) u(n, y, h ? o(m, g, [s.value, y], !0) : s.value);
        return n.length = y, n;
      },
    });
  }, function (e, t, n) {
    ...
    o.beforeSync = function () {
      ...
      if (j && j.length) {
        ...
        0 === D.length && D.push(Promise.resolve()), Promise.all(D)
          .then(function () {
      ...
      function L() {
        if (j) {
          if (_.logger.info('sync::onSyncDone: after sync', a.promises2cmds(j)), j = [], n = F.blacklist || [], r = F.invalidBlacklist || [], s = F.mutelist || [], o = F.invalidMutelist || [], p = F.friends, g = F.invalidFriends || [], h = F.myInfo, y = F.users, v = F.teams, b = F.invalidTeams || [], M = F.sessions, T = F.msgReceipts, S = F.roamingMsgs, k = F.offlineMsgs, P = F.offlineFilterMsgs, C = F.offlineSysMsgs, O = F.offlineCustomSysMsgs, w = F.offlineFilterSysMsgs, x = F.offlineFilterCustomSysMsgs, F.broadcastMsgs, A = F.sysMsgUnread, M) {
            var e = [];
            Object.keys(M)
              .forEach(function (t) {
                e.push(M[t]);
          ...
          R && (c = function () {
            ...
            return e = E.putMsg(n), t.push(e), Promise.all(t)
              .then(function () {
                return n;
              });
          }()
            ...
            R && !_.hasSynced && (_.hasSynced = !0, function () {
              U.syncRelations && (t = E.getRelations()
                .then(function (e) {
              ...
              U.syncFriendUsers && (t = E.getFriends()
                .then(function (e) {
                  return e.map(function (e) {
                    return e.account;
                  });
            ...
            0 === i.length && i.push(Promise.resolve()), Promise.all(i)
              .then(function () {
          ...
          _.logger.warn('sync::onSyncDone: after sync --no promiseArray');
        }
      }

      function B() {
        _.logger.info('sync::onSyncDone: taskAfterSync'), function () {
          if (F.deleteMsgSysMsgs) {
            var e = {};
            ...
            var n = _.api;
            F.deleteMsgSysMsgs.forEach(function (r) {
              ...
              e && e.forEach(function (e) {
                if (e.msgs.length) {
                  ...
                  M = n.cutSessions(M, { id: e.sessionId });
                }
              });
            });
          }
        ...
        var e = [];
        return e.push(_.deleteMsgOfflineRoaming(F.deleteMsgSysMsgs, M)), Promise.all(e);
      }
      ...
      function H() {
        var e,
          t,
          r = [];
        n && (_.logger.info('sync::notifyDataAsync: on blacklist', m(n), n), U.onblacklist(n)), s && (_.logger.info('sync::notifyDataAsync: on mutelist', m(s), s), U.onmutelist(s)), p && (_.logger.info('sync::notifyDataAsync: on friends', m(p), p), U.onfriends(p)), h && (_.logger.info('sync::notifyDataAsync: on myInfo', h), _.myInfo = h, U.onmyinfo(a.copy(h))), y && (y.forEach(function (e) {
          _.mergeUser(e);
        }), _.logger.info('sync::notifyDataAsync: on users', m(y), y), U.onusers(y)), v && (_.logger.info('sync::notifyDataAsync: on teams', d(v), v), U.onteams(v)), T && (!_.hasSynced && M && M.length || _.hasSynced) && (M = _.mergeSessionAndMsgReceipts(M, T)), M && M.length && (M.forEach(function (e) {
          _.syncResult.sessions && _.syncResult.sessions[e.id] && 'number' == typeof _.syncResult.sessions[e.id].unread && (e.unread = _.syncResult.sessions[e.id].unread), _.mergeSession(e), f.trim(e);
        }), _.logger.info('sync::notifyDataAsync: on sessions', l(M), M), U.onsessions(M)), S && S.forEach(function (e) {
        ...
        var i = [],
          o = [];
        F.deleteMsgSysMsgs && F.deleteMsgSysMsgs.forEach(function (e) {
          'roaming' === e.type ? i = i.concat(e.sysMsgs) : o = o.concat(e.sysMsgs);
        }), i.length && (I = (I = I || []).concat(i)), o.length && (C = (C = C || []).concat(o)), I && (_.logger.info('sync::notifyDataAsync: on roaming sys msgs', I.length, I), U.onroamingsysmsgs(I)), C && (_.logger.info('sync::notifyDataAsync: on offline sys msgs', C.length, C), U.onofflinesysmsgs(C)), w && (_.logger.info('sync::notifyDataAsync: on offline filter sys msgs', w.length, w), U.onofflinefiltersysmsgs(w)), O && (_.logger.info('sync::notifyDataAsync: on offline custom sys msgs', O.length, O), U.onofflinecustomsysmsgs(O)), x && (_.logger.info('sync::notifyDataAsync: on offline filter custom sys msgs', x.length, x), U.onofflinefiltercustomsysmsgs(x)), A && (A = a.merge({}, _.sysMsgUnread, A), _.sysMsgUnread = a.merge({}, A), _.logger.info('sync::notifyDataAsync: on sysMsgUnread', A), U.onsysmsgunread(A));
        var c = _.getPushNotificationMultiportConfig();
        _.logger.info('sync::notifyDataAsync: on pushNotificationMultiportConfig', c), U.onPushNotificationMultiportConfig(c), r.length ? (e = Math.max.apply(Math, r), _.updateRoamingMsgTimetag(e)
          .then(W, W)) : W(), _.syncPromiseArray = null, _.syncResult = null;
      }
    ...
    r.assembleLogin = function () {
      ...
      if (t.enable) {
        var n = this.account;
        this.options.appendAppKeyForDBName && (n += '-' + this.options.appKey), this.db.init(n)
          .then(function () {
        ...
        this.logger.info('link::afterLogin: no db'), this.notifyLogin(), this.syncData();
      }
    ...
    r.refreshSocketUrl = function () {
      ...
      function a(t) {
        ...
        s.chunkUploadUrl = t['nos-chunk'] || '', e.logger.info('link::refreshSocketUrl: ajax load, got socket urls ', e.socketUrls), e.connectToUrl(e.getNextSocketUrl());
      }
    ...
    r.putBroadcastMsg = function (e) {
      ...
      return new Promise(function (n) {
        ...
        e.forEach(function (e) {
          e = s.copy(e), t.put('broadcastMsg', e)
            .then(function (e) {
              r.push(e[0]), o();
            }, o);
        });
    ...
    r.putSysMsg = function (e) {
      ...
      if (!e.filter) {
        ...
        return this.getOne('sysMsg', 'idServer', n, { modifyObj: r })
          .then(function (e) {
      ...
      return new Promise(function (n, r) {
        ...
        var i,
          ...
          c = [];
        e.forEach(function (e) {
          i = t.getSysMsgByIdServer(e.idServer)
            .then(function (e) {
      ...
      return this.getAll('sysMsgUnread')
        .then(function (e) {
          var t = {};
          return e.forEach(function (e) {
            t[e.type] = e.num;
    ...
    r.putMsg = function (e) {
      ...
      if (!e.filter) {
        ...
        return t.getOne('msg1', null, n, { modifyObj: r })
          .then(function (e) {
      ...
      var v = h.concat(y);
      1 === v.length ? (p = !0, h = v[0]) : v.length > 1 && (p = !0, g = !0, y = v);
      var b = e.keyword || '',
        M = e.filterFunc,
        T = void 0;
      return (r || p || b || s.isFunction(M)) && (T = function (e) {
      ...
      var t = (e = e || {}).sessionId;
      return this.checkDB(), this.server.query('msg1', 'sessionTime')
      ...
      var e = this;
      return e.getOnly('msg1', 'status', 'sending', { modifyObj: { status: 'fail' } })
        .then(function (t) {
      ...
      var t,
        ...
        r = [];
      return s.isArray(e) || (e = [e]), e.forEach(function (e) {
        t = n.getOne('msg1', null, e, { remove: !0 })
          .then(function (e) {
    ...
    r.mergeMyInfo = function (e, t) {
      ...
      return this.getOne('user', null, n, { modifyObj: e })
        .then(function (r) {
    ...
    r.mergeTeams = function (e, t, n) {
      ...
      var t = this,
        n = (e = s.copy(e)).teamId;
      return t.getOne('team', null, n, { modifyObj: e })
        .then(function (r) {
      ...
      return r.updateTeamMembers([o, a])
        .then(function () {
          return r.putTeam(e)
            .then(function () {
      ...
      var t = this;
      return t.updateTeam({ teamId: e, validToCurrentUser: !1 })
        .then(function () {
      ...
      e = '' + e;
      var t = this;
      return t.getOne('team', null, e)
        .then(function (e) {
          return e ? (t.updateTeamProperties([e]), e) : null;
        });
    }, r.getTeams = function () {
      var e = this;
      return e.getAll('team', { filter: c })
        .then(function (t) {
      ...
      return this.getOnly('teamMember', 'account', e, { filter: u, mapper: l })
        .then();
    }, r.getTeamMembers = function (e) {
      var t = this;
      e = '' + e;
      return t.getOnly('teamMember', 'teamId', e, {
        ...
        .then(function (e) {
          return t.updateTeamMemberProperties(e)
            .then(function () {
              return e;
            });
        });
      ...
      var r,
        s = [];
      return t.forEach(function (t) {
        r = n.getOne('teamMember', null, a.genId(e, t))
          .then(function (e) {
            return l(e);
          }), s.push(r);
      }), Promise.all(s);
      ...
      return this.getOne('teamMember', null, i, { modifyObj: o, mapper: l })
        .then(function (e) {
    ...
    r.mergeFriends = function (e, t, n) {
      var r = this;
      return r.updateAndDelete('friend', e, t)
        .then(function () {
      ...
      var t = this,
        n = (e = s.copy(e)).account;
      return this.getOne('friend', null, n, { modifyObj: e })
        .then(function (r) {
    ...
    r.getTimetags = function (e) {
      ...
      return this.getOne('timetag', null, e)
        .then(function (e) {
      ...
      !function (i, o) {
        var c,
          ...
          b = function (e, t, n) {
              ...
              o = function (r, o, c, d, f, p, g) {
                return new Promise(function (y, v) {
                  var b = s || i ? m : l,
                    ...
                    I = [k],
                    C = 0;
                  f = f || null, p = p || [], 'count' !== c && I.push(d || 'next');
            ...
            'only bound upperBound lowerBound'.split(' ')
              .forEach(function (e) {
                r[e] = function () {
          ...
          S = {
            version: '0.10.2', open: function (e) {
              ...
              return new Promise(function (n, r) {
                if (T[e.server]) {
                  M({ target: { result: T[e.server] } }, e.server, e.version, e.schema)
                    .then(n, r);
                } else {
                  try {
                    t = f()
                      .open(e.server, e.version);
                  } catch (e) {
                    r(e);
                  }
                  t.onsuccess = function (t) {
                    M(t, e.server, e.version, e.schema)
                      .then(n, r);
    ...
    if (f(!!a.getGlobal().indexedDB), 'IE' === r.name && f(!1), 'Microsoft Edge' === r.name && f(!1), 'Safari' === r.name) {
      try {
        parseInt(r.version.split('.')[0], 10) < 10 && f(!1);
      } catch (e) {
      }
      f(!1);
    }
    ...
    g.reset = a.emptyFunc, d && (g.reset = function (e) {
      ...
      return t.addTask(function () {
        return t.enable ? t.server ? Promise.resolve() : (t.name = "nim-" + e, i.open({
          ...
          .then(function (e) {
            ...
            throw f(!1), t.server = null, t.name = null, e
          })) : Promise.reject(l({ callFunc: "db::init" }))
      })
    }, g.destroy = function () {
      var e = this;
      return e.addTask(function () {
        return e.enable ? e.server ? i.remove(e.name)
          .then(function () {
      ...
      var e = this;
      return e.addTask(function () {
        return e.enable ? e.server ? e.server.clear("timetag")
          .then(function () {
      ...
      return n.addTask(function () {
        return n.checkDB(), a.isArray(t) || (t = [t]), n.server.remove(e, t)
          .then(function () {
      ...
      var n = this;
      return n.addTask(function () {
        return n.checkDB(), a.isArray(t) || (t = [t]), n.server.update(e, t)
          .then(function (t) {
            var r = ["put", e],
              i = o.keyPath(e),
              a = [];
      ...
      var t = this,
        ...
        o = a.copy(r);
      return delete o[s], t.getOne(n, null, r[s], { modifyObj: o })
        .then(function (e) {
          return e ? (t.logger.log("db::modifyOrPut: update table " + n, r), e) : (r = a.merge(r, i), t.put(n, r)
            .then(function (e) {
              return e[0]
            }))
        })
      ...
      var n = this;
      return n.addTask(function () {
        return n.checkDB(), (t = t || {}).keys = !0 === t.keys, t.desc = !0 === t.desc, t.distinct = !0 === t.distinct, n.server.query(e, t.index)
          .filter(t.filter)
          .keys(t.keys)
          .desc(t.desc)
          .limit(t.limit)
      ...
      return s.addTask(function () {
        return s.checkDB(), (r = r || {}).keys = !0 === r.keys, r.desc = !0 === r.desc, r.distinct = !0 === r.distinct, r.remove = !0 === r.remove, s.server.query(e, t)
          .only(n)
          .filter(r.filter)
          .keys(r.keys)
          .desc(r.desc)
      ...
      return this.getOnly.apply(this, arguments)
        .then(function (e) {
          return e[0]
        })
