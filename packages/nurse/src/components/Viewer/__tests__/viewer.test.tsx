...
class ViewerTester extends React.Component<ViewerTesterProps & ViewerProps, any> {
  ...
  render() {
    const {
      hasContainer, images, onChangeImages, ...viewerProps
    } = this.props;
    ...
    return (
      <div>
        ...
        <div id="container" ref={(ref) => { this.container = ref; }} style={{ width: '150px', height: '150px' }} />
        <Viewer
...
describe('Viewer', () => {
  ...
  it('custom toolbar', () => {
    ...
    viewerHelper.new({
      customToolbar: (toolbars) => toolbars.concat([{
        key: 'test',
