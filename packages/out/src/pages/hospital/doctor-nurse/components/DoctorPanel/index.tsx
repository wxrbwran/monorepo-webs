...
import { Search, AccountStatus } from 'xzl-web-shared/dist/src/components/Selects';
...
import { name, tel, sex, title, patientNum, departmentName, status } from 'xzl-web-shared/dist/src/utils/columns';
