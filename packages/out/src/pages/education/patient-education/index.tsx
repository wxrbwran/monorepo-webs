                  ...
                  <div className={styles.item}>
                    ...
                    {item.conditions.map((i) => (
                      <>
                        ...
                        {i.type === 'sex' && (
                          <p className={styles.con}>性别：{i.value}</p>
                        )}
                      </>
                    ))}
                    {!!diagnosisArr?.length && (
                      <p className={styles.con}>诊断：{diagnosisArr.map((i) => i.value).join(', ')}</p>
                    )}
                    {!!treatmentArr?.length && (
                      <p className={styles.con}>处理：{treatmentArr.map((i) => i.value).join(', ')}</p>
                    )}
                  </div>
                </div>
              </div>
