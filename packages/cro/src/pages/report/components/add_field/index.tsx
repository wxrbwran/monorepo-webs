  ...
  return (
    <>
      ...
      <DragModal
        ...
        footer={null}
      >
        <Checkbox.Group data-testid="checkbox" options={options} defaultValue={checkTitle} value={checkTitle} onChange={onChange} />
        <div className="submit-btn-style1">
          <Button data-testid="cancel" onClick={() => setIsShowModal(false)} > 取消 </Button>
          <Button type="primary" onClick={handleChangeField} > 确定 </Button>
        </div>
      </DragModal>
    </>
  )
